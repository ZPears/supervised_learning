...
class AbaloneData(DataLoader):
    def __init__(self, path='data/cleaned_abalone_data.csv', verbose=False, seed=1):
...
class CategoricalCreditDefaultData(DataLoader):

    def __init__(self, path='data/categorical_default_data.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def data_name(self):
        return 'CleanedCreditDefaultData'
...
class MergedCreditDefaultData(DataLoader):

    def __init__(self, path='data/merged_categorical_default_data.csv', verbose=False, seed=1):
        super().__init__(path, verbose, seed)
    ...
    def data_name(self):
        return 'MergedCreditDefaultData'
