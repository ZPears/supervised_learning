...
if __name__ == '__main__':
    ...
    ds1_details = {
            'data': loader.CategoricalCreditDefaultData(verbose=verbose, seed=seed),
            'name': 'categorical_credit_default',
            'readable_name': 'Categorical Credit Default',
        }

    ds2_details = {
        'data': loader.MergedCreditDefaultData(verbose=verbose, seed=seed),
        'name': 'merged_credit_default',
        'readable_name': 'Merged Credit Default',
    }

    ds3_details = {
        'data': loader.AbaloneData(verbose=verbose, seed=seed),
        'name': 'abalone_data',
        'readable_name': 'Abalone Data',
    }
